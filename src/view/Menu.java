...
//        menu.put(-1, "Предыдущее меню");
    ...
    private void printMenuAdmin() {
        ...
        // Todo
        //  1. сменить роль пользователя
        //  2. изменить курс валюты
        //  3. экспорт транзакций пользователей
        //  4. импорт изменения курса валюты
        //  5. история изменения курса валюты
        //  -1. предыдущее меню (над "⏻ Выход в главное меню")
